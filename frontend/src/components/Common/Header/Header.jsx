...
const Header = () => {
  ...
  const statusDot = (status) => {
    if (status === 'running' || status === 'connected') return 'bg-green-500 animate-pulse';
            ...
            {profileOpen && (
              <div className="absolute right-0 mt-2 w-56 bg-gray-800 border border-gray-700 rounded-xl shadow-xl overflow-hidden">
                ...
                <button
                  ...
                  className="w-full px-4 py-2 text-left text-red-400 hover:bg-red-900/30 flex items-center gap-2"
                >
